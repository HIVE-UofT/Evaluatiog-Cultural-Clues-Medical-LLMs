#!/bin/bash
#SBATCH --job-name=run_llama_option_diagnose     # Job name
#SBATCH --output=llama_option_diagnose_%j.out
#SBATCH --error=llama_option_diagnose_%j.err
...
python /home/haji80as/EMBC_project/llama_option_diagnose.py