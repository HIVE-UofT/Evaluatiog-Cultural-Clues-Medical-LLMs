#!/bin/bash
#SBATCH --job-name=run_medgemma4b_option_diagnose     # Job name
#SBATCH --output=medgemma4b_option_diagnose_%j.out
#SBATCH --error=medgemma4b_option_diagnose_%j.err
...
python /home/haji80as/EMBC_project/medgemma4b_option_diagnose.py