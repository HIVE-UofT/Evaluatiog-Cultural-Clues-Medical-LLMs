#!/bin/bash
#SBATCH --job-name=run_medgemma27b_option_diagnose     # Job name
#SBATCH --output=medgemma_option_diagnose_%j.out
#SBATCH --error=medgemma_option_diagnose_%j.err
...
python /home/haji80as/EMBC_project/medgemma27b_option_diagnose.py