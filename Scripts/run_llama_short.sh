#!/bin/bash
#SBATCH --job-name=run_llama_short_diagnose     # Job name
#SBATCH --output=llama_short_diagnose_%j.out
#SBATCH --error=llama_short_diagnose_%j.err
...
python /home/haji80as/EMBC_project/llama_short_diagnose.py