#!/bin/bash
#SBATCH --job-name=run_medgemma27b_short_diagnose     # Job name
#SBATCH --output=medgemma27b_short_diagnose_%j.out
#SBATCH --error=medgemma27b_short_diagnose_%j.err
...
python /home/haji80as/EMBC_project/medgemma27b_short_diagnose.py