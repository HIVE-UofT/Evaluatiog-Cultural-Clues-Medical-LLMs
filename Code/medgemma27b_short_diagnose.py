...
for chats in tqdm(all_chats):
    ...
    if len(all_answers) % 10 == 0:
        with open('/home/haji80as/EMBC_project/new_answers/MedGemma27B_short_augment_answers.json', 'w') as f:
            f.write(json.dumps(all_answers))
            f.close()

with open('/home/haji80as/EMBC_project/new_answers/Final_MedGemma27B_short_augment_answers.json', 'w') as f:
            f.write(json.dumps(all_answers))
            f.close()
